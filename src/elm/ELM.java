...
//		System.out.println("numTrainData: " +numTrainData);
		NumberofInputNeurons = train_set.numColumns() - 1;
//		System.out.println("numOfInputNeurons: " +NumberofInputNeurons);
...
//		}
	...
	public void setInputWeight(DenseMatrix matrix){
		InputWeight = matrix;
	}
	
	public void setOutputWeight(DenseMatrix matrix){
		OutputWeight = matrix;		
	}
